...
$form = "Dengan hidup beragama akan memberikan rasa tenang dan bahagia.";

$form1 = "Ajaran keagamaan membawa pada  ketenangan dan kebahagiaan hidup";
//$kgrams = $_POST['kgram'];
...
echo $output   = $stemmer->stem($tokenizing9);
