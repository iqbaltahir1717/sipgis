...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container-fluid px-md-4   ">
     <!--<img src="<?php echo base_url()?>upload/setting/logoo.png" height="70" style="padding-top: -10px;">-->
  ...
  <div class="hero-wrap img" style="background-image: url(<?php echo base_url() ?>assets/front/images/image_1.jpg);" id="one">
      ...
      <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-10 d-flex align-items-center ftco-animate">
          <div class="text text-center pt-5 mt-md-5">
            ...
            <!--<h1 class="mb-10">Website Resmi <br>Kelas Premium Praktisi Pengadaan Barang/Jasa</h1>-->
            
            <h1 class="mb-10">Website Resmi<br>Sistem Informasi Pencarian Tugas Akhir dan Kuliah Praktek<br>Jurusan Teknik Informatika<br>Universitas Halu Oleo</h1>
