      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            <h2>Masukkan Judul Proposal KP Untuk Mencari KP</h2>

            <?php echo form_open("front/kp_pr")?>
                        ...
                        <tbody>
                          ...
                          foreach ($list as $ab=>$key) { 
                            ...
                            <tr>
                              <td><?php echo $no; ?></td>
                              <td>
                                <a href="<?php echo base_url() . 'upload/kp/kp_file/'.$key[5]?>" class="btn btn-warning btn-icon-split btn-sm" target="_blank">
                                  <span class="text">
                                    <i class="fa fa-eye"></i>
                                  </span>
                                </a>
