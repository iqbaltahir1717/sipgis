...
function katahubung($stringg) {
    ...
    $stringg = str_replace('adalah', '', $stringg);
    $stringg = str_replace('yang', '', $stringg);
    $stringg = str_replace('untuk', '', $stringg);
    $stringg = str_replace('adanya', '', $stringg);
    $stringg = str_replace('adapun', '', $stringg);
    $stringg = str_replace('agak', '', $stringg);
    $stringg = str_replace('akhirnya', '', $stringg);
    $stringg = str_replace('amat', '', $stringg);
    $stringg = str_replace('begitupun', '', $stringg);
    $stringg = str_replace('jadinya', '', $stringg);
